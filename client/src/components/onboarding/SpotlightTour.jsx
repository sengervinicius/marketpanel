...
const STEPS = [
  ...
  { type: 'target', sel: '[data-panel-id="bloombergTV"]', eyebrow: 'LIVE TV', title: 'Live TV, in your terminal',
    body: 'Business television streams right here — audio and video, no second screen needed. Bloomberg is the default; the chips switch to Yahoo Finance, CNBC or Reuters when a network is between streams.' },
