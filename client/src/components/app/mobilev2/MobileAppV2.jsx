...
export default function MobileAppV2(){
  ...
  const NAMES={SPY:'S&P 500',QQQ:'Nasdaq 100',DIA:'Dow Jones',IWM:'Russell 2000',EWZ:'Ibovespa',EFA:'EAFE',EWJ:'Japan',EEM:'Emerging Mkts',FXI:'China',AAPL:'Apple',NVDA:'Nvidia',MSFT:'Microsoft',TSLA:'Tesla',AMZN:'Amazon',GOOGL:'Alphabet',META:'Meta',GLD:'Gold',SLV:'Silver',USO:'WTI crude',UNG:'Nat gas',CORN:'Corn',CPER:'Copper',EURUSD:'EUR / USD',USDBRL:'USD / BRL',USDJPY:'USD / JPY',GBPUSD:'GBP / USD',BTCUSD:'Bitcoin',ETHUSD:'Ethereum',SOLUSD:'Solana',VALE:'Vale',PBR:'Petrobras','GC=F':'Gold','CL=F':'WTI Crude','SI=F':'Silver','NG=F':'Nat Gas','HG=F':'Copper','BZ=F':'Brent','ZC=F':'Corn','ES=F':'S&P Futures','EUR/USD':'EUR / USD','RENT3.SA':'Localiza','U':'Unity','ZS=F':'Soybeans','ZW=F':'Wheat','ZC=F':'Corn','KC=F':'Coffee','SB=F':'Sugar','CT=F':'Cotton','LE=F':'Live Cattle','PA=F':'Palladium','PL=F':'Platinum','^N225':'Nikkei 225','^GDAXI':'DAX','^FTSE':'FTSE 100','^FCHI':'CAC 40','^HSI':'Hang Seng','^BVSP':'Ibovespa','^GSPC':'S&P 500','^IXIC':'Nasdaq Composite','^DJI':'Dow Jones','VALE3.SA':'Vale','PETR4.SA':'Petrobras PN','PETR3.SA':'Petrobras ON','ITUB4.SA':'Itaú Unibanco','ONCO3.SA':'Oncoclínicas','ABEV3.SA':'Ambev','BBDC4.SA':'Bradesco','B3SA3.SA':'B3','C:USDBRL':'USD / BRL','C:GBPBRL':'GBP / BRL','X:BTCUSD':'Bitcoin','MSFT':'Microsoft','GOOGL':'Alphabet','GS':'Goldman Sachs','V':'Visa','MA':'Mastercard','DIA':'Dow Jones'};
