    ...
    >
      <defs>
        ...
        {glow && (
          <radialGradient id={ids.glow} cx="50%" cy="50%" r="50%">
            ...
            <stop offset="40%" stopColor="#DAA520" stopOpacity="0.12" />
            <stop offset="70%" stopColor="#DAA520" stopOpacity="0.04" />
      ...
      <g className={`v-ring2-${uid}`}>
        <ellipse cx="32" cy="32" rx="24" ry="10"
          fill="none" stroke="#DAA520" strokeWidth="0.4" strokeOpacity="0.14"
          transform="rotate(-25 32 32)" />
        {/* Orbiting micro-particle on ring 2 */}
        <circle cx="56" cy="32" r="1.2" fill="#DAA520" fillOpacity="0.35"
      ...
      <g className={`v-ring1-${uid}`}>
        ...
        <circle cx="51" cy="32" r="1.5" fill="#FFE4A0" fillOpacity="0.6"
          className={`v-dot-${uid}`}
          transform="rotate(15 32 32)" />
        <circle cx="13" cy="32" r="0.8" fill="#DAA520" fillOpacity="0.3"
      ...
      <g className={`v-core-${uid}`}>
        {/* Soft outer bloom */}
        <circle cx="32" cy="32" r="15" fill="#DAA520" fillOpacity="0.08" />
        {/* Main sphere */}
      ...
      <circle cx="10" cy="14" r="0.6" fill="#DAA520" fillOpacity="0.25"
      ...
      <circle cx="14" cy="50" r="0.5" fill="#DAA520" fillOpacity="0.15"
