    ...
    >
      <defs>
        ...
        <radialGradient id={ids.orb} cx="40%" cy="36%" r="55%" fx="38%" fy="34%">
          ...
          <stop offset="45%" stopColor={TOKEN_HEX.accent} />
        ...
        {glow && (
          <radialGradient id={ids.glow} cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor={TOKEN_HEX.accent} stopOpacity="0.40" />
            <stop offset="40%" stopColor={TOKEN_HEX.accent} stopOpacity="0.12" />
            <stop offset="70%" stopColor={TOKEN_HEX.accent} stopOpacity="0.04" />
      ...
      <g className={`p-ring2-${uid}`}>
        <ellipse cx="32" cy="32" rx="24" ry="10"
          fill="none" stroke={TOKEN_HEX.accent} strokeWidth="0.4" strokeOpacity="0.12"
          transform="rotate(-25 32 32)" />
        {/* Orbiting micro-particle on ring 2 */}
        <circle cx="56" cy="32" r="1.2" fill={TOKEN_HEX.accent} fillOpacity="0.35"
      ...
      <g className={`p-ring1-${uid}`}>
        <ellipse cx="32" cy="32" rx="19" ry="7"
          fill="none" stroke={TOKEN_HEX.accent} strokeWidth="0.5" strokeOpacity="0.20"
          transform="rotate(15 32 32)" />
        {/* Orbiting micro-particle on ring 1 */}
        <circle cx="51" cy="32" r="1.5" fill="#FFB347" fillOpacity="0.6"
          className={`p-dot-${uid}`}
          transform="rotate(15 32 32)" />
        <circle cx="13" cy="32" r="0.8" fill={TOKEN_HEX.accent} fillOpacity="0.3"
      ...
      <g className={`p-core-${uid}`}>
        {/* Soft outer bloom */}
        <circle cx="32" cy="32" r="15" fill={TOKEN_HEX.accent} fillOpacity="0.08" />
        {/* Main sphere */}
      ...
      <circle cx="10" cy="14" r="0.6" fill={TOKEN_HEX.accent} fillOpacity="0.25"
        className={`p-dot-${uid}`} style={{ animationDelay: '0.3s' }} />
      <circle cx="52" cy="48" r="0.5" fill={TOKEN_HEX.accent} fillOpacity="0.20"
      ...
      <circle cx="14" cy="50" r="0.5" fill={TOKEN_HEX.accent} fillOpacity="0.15"
