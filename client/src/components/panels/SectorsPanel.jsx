...
// Per-horizon "full tint" scale: a 1D move of 2% is as loud as a YTD move
// of 20%. Opacity grades linearly up to the cap so a flat tape reads calm.
const FULL_SCALE = { '1D': 2, '1W': 4, '1M': 8, 'YTD': 20 };
const MAX_TINT = 42; // % of the token color mixed in at full scale
const MIN_TINT = 5;
