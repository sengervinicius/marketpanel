...
export const INSTRUMENTS = [
  ...
  { symbolKey: 'GLD',  name: 'Gold',               assetClass: 'commodity',    group: 'Metals',      isETFProxy: true, underlyingName: 'Gold',        underlyingUnit: 'oz',    conversionFactor: 10 },
  { symbolKey: 'SLV',  name: 'Silver',             assetClass: 'commodity',    group: 'Metals',      isETFProxy: true, underlyingName: 'Silver',      underlyingUnit: 'oz',    conversionFactor: 100 },
  { symbolKey: 'CPER', name: 'Copper',             assetClass: 'commodity',    group: 'Metals',      isETFProxy: true, underlyingName: 'Copper',      underlyingUnit: 'lb' },
  { symbolKey: 'REMX', name: 'Rare Earth',         assetClass: 'commodity',    group: 'Metals',      isETFProxy: true, underlyingName: 'Rare Earths' },
  { symbolKey: 'USO',  name: 'WTI Oil',            assetClass: 'commodity',    group: 'Energy',      isETFProxy: true, underlyingName: 'WTI Crude Oil', underlyingUnit: 'bbl' },
  { symbolKey: 'UNG',  name: 'Natural Gas',        assetClass: 'commodity',    group: 'Energy',      isETFProxy: true, underlyingName: 'Natural Gas', underlyingUnit: 'MMBtu' },
  { symbolKey: 'SOYB', name: 'Soybeans',           assetClass: 'commodity',    group: 'Agriculture', isETFProxy: true, underlyingName: 'Soybeans',    underlyingUnit: 'bu' },
  { symbolKey: 'WEAT', name: 'Wheat',              assetClass: 'commodity',    group: 'Agriculture', isETFProxy: true, underlyingName: 'Wheat',       underlyingUnit: 'bu' },
  { symbolKey: 'CORN', name: 'Corn',               assetClass: 'commodity',    group: 'Agriculture', isETFProxy: true, underlyingName: 'Corn',        underlyingUnit: 'bu' },
