    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ color: 'var(--accent, #e55a00)', fontSize: 10, fontWeight: 700, letterSpacing: '1.5px', marginBottom: 4 }}>SENGER MARKET</div>
        ...
        >
          <p style={{ marginBottom: 12 }}>By using Senger Market Terminal, you agree to the following terms:</p>
          <p style={{ marginBottom: 12 }}><strong style={{ color: 'var(--text-primary, #e0e0e0)' }}>Financial Disclaimer:</strong> All data and information provided through Senger Market Terminal is for informational and educational purposes only. It should not be construed as financial advice, investment recommendations, or an offer to buy or sell securities.</p>
          <p style={{ marginBottom: 12 }}><strong style={{ color: 'var(--text-primary, #e0e0e0)' }}>No Guarantee of Accuracy:</strong> While we strive for accuracy, market data may be delayed or contain errors. ARC Capital makes no warranty regarding the completeness or reliability of any information displayed.</p>
          ...
          <p style={{ marginBottom: 12, color: 'var(--text-faint, #666)', fontSize: 11 }}>For the full Terms of Service, visit <a href="/terms" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent, #e55a00)' }}>sengermarket.com/terms</a></p>
        </div>
        <div style={{
