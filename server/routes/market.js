...
// yahoo-finance2 is ESM-only; its default export is the YahooFinance class constructor
...
// ─── Brazilian stocks (direct Yahoo Finance HTTP — more reliable than npm pkg) ──
router.get('/snapshot/brazil', async (req, res) => {
  try {
    ...
    const url = `https://query1.finance.yahoo.com/v7/finance/quote?symbols=${symbols}&fields=regularMarketPrice,regularMarketChange,regularMarketChangePercent,regularMarketVolume,shortName&lang=en-US&region=BR`;
